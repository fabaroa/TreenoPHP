<?php
//$Id: zipbackup.php 14650 2012-02-02 21:58:05Z acavedon $
 ...
 *	* means that they are file ids
 ...
 $cmd = $DEFS['PHP_EXE'] . ' -q ' . 
 	escapeshellarg ($DEFS['DOC_DIR'] . '/bots/zipbackup.php') . ' ' .
...
$fileArr = cabinetXMLTree($db_object, $cabinets, $tempTable, $is_files, $tmpXML, $db_name, $username);
