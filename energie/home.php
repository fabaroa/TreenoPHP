<?php
// $Id: home.php 14705 2012-02-21 19:59:13Z acavedon $
...
function deleteCabinet( cabinet)
{
        ...
        if(answer == true) {
			parent.mainFrame.window.location = 'search_frame.php?delete=1&cabinet='+cabinet;
...
HTML;
	...
	foreach ($newCabList as $myCab => $myNum) {
		if ($user->cabArr[$myCab]) {
			...
			echo "<td onclick=\"submitAll('$myCab');\">\n";
			...
			echo "</td>\n";
			echo "<td style=\"text-align: left\" onclick=\"submitAll('$myCab');\">";
			echo $tmp;
			echo "</td>\n";
			echo "<td onclick=\"submitAll('$myCab');\" ";
