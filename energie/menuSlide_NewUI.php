<?php
// $Id: menuSlide.php 14369 2011-05-12 17:37:41Z cz $
...
<script>
   ...
   function restoreDefault(type) {
	    ...
	    window.location='../energie/menuSlide_NewUI.php?restore=1';
	    parent.searchPanel.window.location = '../energie/searchPanel.php';
	    removeBackButton();
   }
...
ENERGIE;
		if( isset($enabledLinks) and check_enable('workflow', $user->db_name) and in_array("todo",$enabledLinks) ) {
			if($user->restore) {
			echo<<<ENERGIE
...
ENERGIE;
	...
	echo<<<ENERGIE
<td class="mainMenu" onclick="top.window.close()">
<img class="menuBtn" src="../images/close_16.gif" alt="Logout" />
<span class="lnk" style="vertical-align:15%">Close</span>
</td>
</tr>
</table>
</td>
