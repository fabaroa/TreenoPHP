...
Patch14: php-4.3.11-gdheaders.patch

# Fixes for extension modules
Patch22: php-4.3.2-db4.patch
Patch24: php-4.3.8-gdnspace.patch
Patch25: php-4.3.11-shutdown.patch
...
%patch11 -p1 -b .select
%patch13 -p1 -b .round
%patch14 -p1 -b .gdheaders

%patch22 -p1 -b .db4
%patch24 -p1 -b .gdnspace
%patch25 -p1 -b .shutdown
...
pushd pear/packages
  # Add PEAR packages omitted from the 4.3.11 tarball
  cp %{SOURCE20} %{SOURCE21} %{SOURCE22} %{SOURCE23} \
     %{SOURCE24} %{SOURCE25} .
  gunzip *.tgz

  # Remove packages added since 4.3.10
...
%changelog
* Wed Apr 27 2005 Joe Orton <jorton@redhat.com> 4.3.11-2.5
...
* Tue Dec 21 2004 Joe Orton <jorton@redhat.com> 4.3.10-3.2
- fix umask patch (#143286)

* Wed Dec 15 2004 Joe Orton <jorton@redhat.com> 4.3.10-3.1
