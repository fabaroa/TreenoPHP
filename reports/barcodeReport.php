...
<head>
	...
	function genReport() {
		...
		if(date1 != "") {
			var xmlArr = {	"include"	: "reports/chkFilesForBCs.php",
							"function"	: "startBCReport",
							"startDate"	: date1,
							"endDate"	: date2		};
			postXML(xmlArr);
		} 
	...
	function updateMess(XML) {
		var eMsg = $('errMsg');
		removeElementsChildren(eMsg);
		eMsg.appendChild(document.createTextNode('Barcode report started and will be placed into your inbox'));
	}
	</script>
</head>
