...
$cabinetID=9;
$userName="admin";
$path="C:\Iron Mountain\BoW Iron Mountain\BoW Iron Mountain\VOLUME 5";
	...
	while(false !== ($file = readdir($hd))) {
		if(is_file($path."/".$file)) {
			if($file != "ERROR.txt" && $file != "INDEX.DAT") {
				...
				{
					$pathTo="C:\Iron Mountain\BoW Iron Mountain\BoW Iron Mountain\TEMP";
