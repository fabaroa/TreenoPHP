...
<link rel="stylesheet" type="text/css" href="viewFileHistory.css"/>
...
if ($logged_in == 1 and 
	strcmp($user->username, "") != 0 and
	$cabSecurity and
	$user->checkSetting('versioning', $cabinetName)) {
	...
	foreach ($versFileList as $currFile) 
	{
		...
		$date_created = $currFile['date_created'];
		$who_created = $currFile['who_indexed'];
